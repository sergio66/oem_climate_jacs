...
% iaJacob(4) = 6
% iaJacob(5) = 51
tracegas = rad2bt(c.fKc,c.rKc(:,[1 2 4 5])) - rad2bt(c.fKc,r.rKc)*ones(1,4);
stemp    = rad2bt(c.fKc,c.rKc(:,[7]))       - rad2bt(c.fKc,r.rKc);
...
saver = ['save JUNK/jac_results_' num2str(iiBin) '.mat water ozone tempr tracegas stemp'];
eval(saver);
