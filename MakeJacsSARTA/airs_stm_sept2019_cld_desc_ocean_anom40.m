...
topts.fINPUT_rtp = ['AnomSymCld_no_seasonal_desc_ocean/timestep_' num2str(iTimeStep,'%03d') '_16day_avg.rp.rtp'];   %% profiles no have seasonal, trace gas fine

iNewOrOldSarta = -1;
iNewOrOldSarta = +1;
if iNewOrOldSarta == +1
  %topts.savedir = ['SARTA_AIRSL1c_Anomaly365_16_CLD/' num2str(iTimeStep,'%03d') '/'];
  topts.savedir = ['SARTA_AIRSL1c_Anomaly365_16_CLD_desc_ocean/' num2str(iTimeStep,'%03d') '/'];
