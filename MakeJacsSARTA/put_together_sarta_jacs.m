...
elseif params.iJacType == 100
  ...
  %% ORIG
  str1 = {'CO2' 'N2O'  'CH4' 'CFC11'  'ST'  'CNG1' 'CNG2' 'CSZ1' 'CSZ2' 'CPR1' 'CPR2' 'WV(97)'  'T(97)'  ' O3(97)'};
  str2 = '[ [2.2 1.0 5 1 0.1][0.001 0.001 0.001 0.001 0.001 0.001] [0.1*ones(1,97)] [0.5*ones(1,97)]] [0.01*ones(1,97)]]';
  qrenorm = [[2.2 1.0 5 1 0.1] [0.001*ones(1,6)] [0.1*ones(1,97)] [0.5*ones(1,97)] [0.01*ones(1,97)]];

  %% NEW, see normer.cld
  str1 = {'CO2' 'N2O'  'CH4' 'CFC11'  'ST'  'CNG1' 'CNG2' 'CSZ1' 'CSZ2' 'CPR1' 'CPR2' 'WV(97)'  'T(97)'  ' O3(97)'};
  str2 = '[ [2.2 1.0 5 1 0.1][0.001 0.001 0.001 0.001 0.001 0.001] [0.01*ones(1,97)] [0.01*ones(1,97)]] [0.01*ones(1,97)]]';
  qrenorm = [[2.2 1.0 5 1 0.1] [0.01*ones(1,6)] [0.01*ones(1,97)] [0.01*ones(1,97)] [0.01*ones(1,97)]];
