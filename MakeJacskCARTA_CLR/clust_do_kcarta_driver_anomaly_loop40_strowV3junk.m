...
for iiBin = iiBinS : iiBinE
  ...
  outputmatfile = [outdir '/strowfinitejac_convolved_kcarta_airs_' num2str(iLatbin) '_jac2.mat']; %% done July2        better        CO2/N2O/CH4 profs
...
%}
  saver = ['save ' outputmatfile ' fKc rKc sfile  use_this_rtp0 use_this_rtp370'];
  eval(saver)
