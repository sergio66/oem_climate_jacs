...
%for latbin = 1:40
  ...
  iipert0 = 1;
  for iipert = 1 : length(iaCH4)
    fprintf(1,'latbin %2i ijac %2i \n',latbin,iipert)
    if iipert == 1
      kcrad = ['CH4_1700_2000/junkCH4_latbin_' num2str(latbin) '_ch4pert_' num2str(iipert) '.dat'];
      kcjac = ['CH4_1700_2000/junkCH4_latbin_' num2str(latbin) '_ch4pert_' num2str(iipert) '.jac_COL'];
    else
      kcrad = ['CH4_1700_2000/junkCH4_latbin_' num2str(latbin) '_ch4pert_' num2str(iipert0) '.dat'];
      kcjac = ['CH4_1700_2000/junkCH4_latbin_' num2str(latbin) '_ch4pert_' num2str(iipert) '.dat'];
    end
  ...
  %% above is jac for 10% change (which starting from eg 1800 ppb is [0.180 25 50 75 100 .... 300] ppmb change ... so what is it for 5 ppmb change??)
  qcx = qc * (5./(1860 * dQkc));
  plot(fc,qcx)
  ...
  saver = ['save CH4_1700_2000/ch4_jac_2834_latbin' num2str(latbin) 'v2.mat fc qc qcx iaCH4 comment'];
  eval(saver);
