...
for ll = JOB
  ...
  for ii = 1 : length(iaCO2)
    ...
    sedder = ['!sed -e "s/XYZXYZ/' num2str(ll) '/g" -e "s/MMM/' num2str(ii) '/g" templatejacCO2_370_385_400_415_col.nml > CO2_370_385_400_415//junk' num2str(ll) '.nml' ];
    eval(sedder)
    kcrad = ['CO2_370_385_400_415/junkCO2_latbin_' num2str(ll) '_co2pert_' num2str(ii) '.dat'];
    kcjac = ['CO2_370_385_400_415/junkCO2_latbin_' num2str(ll) '_co2pert_' num2str(ii) '.jac'];
