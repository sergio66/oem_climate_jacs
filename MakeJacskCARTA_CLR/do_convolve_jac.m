function [w,d] = do_convolve_jac(iInstr,iTimeStep,iiBin,iDoJac,kcvers,iAIRSorCRIS);
...
elseif iDoJac == 100
  ...
  %[junk_rad,dall,w] = readkcPCLSAM_coljac([outdir '/radc.dat' num2str(iiBin)],[outdir '/jacc.dat' num2str(iiBin) '_COL']);
end
