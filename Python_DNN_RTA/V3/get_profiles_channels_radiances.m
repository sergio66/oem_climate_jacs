...
for ii = 1 : length(p.stemp)
  ...
  dT = interp1(plays/p_end,y-yf,refSigma,'linear','extrap');
  dt1_00(ii,1:100) = viewAngleSecant_00(ii) * dT;
  dt2_00(ii,1:100) = (viewAngleSecant_00(ii))^2 * dT;  
  dt3_00(ii,1:100) = viewAngleSecant_00(ii) * dT .* dT;
  dt4_00(ii,1:100) = (viewAngleSecant_00(ii))^2 * dT.*dT;  
  dt5_00(ii,1:100) = dT;
  dt6_00(ii,1:100) = dT .* dT;    
  ...
  wr = interp1(plays/p_end,y./yf,refSigma,'linear','extrap');
  Wr1_00(ii,1:100) = viewAngleSecant_00(ii) * wr;
  Wr2_00(ii,1:100) = viewAngleSecant_00(ii) * sqrt(wr);
  Wr3_00(ii,1:100) = viewAngleSecant_00(ii) * wr .* dT;
  Wr4_00(ii,1:100) = (viewAngleSecant_00(ii) * wr).^2;
  Wr5_00(ii,1:100) = viewAngleSecant_00(ii) * sqrt(wr) .* dT;
  Wr6_00(ii,1:100) = viewAngleSecant_00(ii) * (sqrt(wr) .* dT).^2;
  Wr7_00(ii,1:100) = (viewAngleSecant_00(ii))^2 * wr;
  ...
  or = interp1(plays/p_end,y./yf,refSigma,'linear','extrap');
  Or1_00(ii,1:100) = viewAngleSecant_00(ii) * or;
  Or2_00(ii,1:100) = viewAngleSecant_00(ii) * sqrt(or);
  Or3_00(ii,1:100) = viewAngleSecant_00(ii) * or .* dT;
  Or4_00(ii,1:100) = (viewAngleSecant_00(ii) * or).^2;  
  Or5_00(ii,1:100) = viewAngleSecant_00(ii) * sqrt(or) .* dT;
  Or6_00(ii,1:100) = viewAngleSecant_00(ii) * (sqrt(or) .* dT).^2;
  Or7_00(ii,1:100) = (viewAngleSecant_00(ii))^2 * or;
