function [B,se,anomaly] = Math_sincosfit4(x,y,iDebug)
...
s0 = [ym;  lin; yr*[1 1 1/2 1/2 1/4 1/4 1/8 1/8]'];                              % starting guess
topt = optimset(MaxFunEvals = 200*10);    %% default
topt = optimset(MaxFunEvals = 200*100);   %% new
topt = optimset(MaxFunEvals = 200*1000);  %% new
s = fminsearch(fcn, s0, topt);                                                   % Minimise Least-Squares
