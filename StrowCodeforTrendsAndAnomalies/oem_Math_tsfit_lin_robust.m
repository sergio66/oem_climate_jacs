function [bjn,coeffssigbjn,dofs] = oem_Math_tsfit_lin_robust(dtime,r,iNterms,b00,unc,uncB);
...
if nargin == 4
  disp('nargin = 4, oem_Math_tsfit_lin_robust.m is using unc = 0.25');
  unc = 0.25;
  disp('nargin = 4, oem_Math_tsfit_lin_robust.m is using uncB = 1');
  uncB = 1.0;
elseif nargin == 5
  disp('nargin = 5, oem_Math_tsfit_lin_robust.m is using uncB = 1');
  uncB = 1.0;
end
