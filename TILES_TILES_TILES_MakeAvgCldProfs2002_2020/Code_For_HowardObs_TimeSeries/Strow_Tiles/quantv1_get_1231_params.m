...
dbt_asc = NaN(64,72,2,16);
dbt_desc = NaN(64,72,2,16);

dbt_err_asc = NaN(64,72,2,16);
dbt_err_desc = NaN(64,72,2,16);

b_asc = NaN(64,72,2,16,10);
b_desc = NaN(64,72,2,16,10);


berr_asc = NaN(64,72,2,16,10);
berr_desc = NaN(64,72,2,16,10);


lag_asc = NaN(64,72,2,16);
lag_desc = NaN(64,72,2,16);
