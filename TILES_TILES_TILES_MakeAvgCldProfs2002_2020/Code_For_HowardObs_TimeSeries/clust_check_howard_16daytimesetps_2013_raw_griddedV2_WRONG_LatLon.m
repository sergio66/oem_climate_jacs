...
iVers = 0;  %% use JOB together with hugedir = dir('/asl/isilon/airs/tile_test7/'); or di('/umbc/rs/strow/asl/airs/tile_test7/')
...
%% input  dir = /umbc/rs/strow/asl/airs/tile_test7/HowardsTIlingMap, this could be corrected eg using  x = translator_wrong2correct(JOB);
...
%% ls /umbc/rs/strow/asl/airs/tile_test7/2008_s142/N52p25 | wc -l = 072 LONBINS
