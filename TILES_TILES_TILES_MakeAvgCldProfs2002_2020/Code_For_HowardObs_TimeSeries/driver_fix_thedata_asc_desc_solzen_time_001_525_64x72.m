...
disp('now run off driver_loop_get_asc_desc_solzen_time.m AFTER you have made eg ')
disp('  ../DATAObsStats_StartSept2002_CORRECT_LatLon/LatBin01/LonBin01/iQAX_3_summarystats_LatBin01_LonBin01_timesetps_001_525_V1.mat');
disp('  which happens after you have finished running cluster_loop_make_correct_timeseriesV2')

disp('now run off driver_loop_get_asc_desc_solzen_time.m')
disp('  ../DATAObsStats_StartSept2002_CORRECT_LatLon/LatBin01/LonBin01/iQAX_3_summarystats_LatBin01_LonBin01_timesetps_001_525_V1.mat');
disp('  which happens after you have finished running cluster_loop_make_correct_timeseriesV2')
