...
%%% iQAX = -1; %% extreme                  RETIRED GONE POOF FINITO ZE-END NO-MORE
...
iQAX = +3; %% quantile                 quants = [0.50 0.8 0.9 0.95 0.97 1.00];   %%% TRENDS PAPER DEFAULT DEFAULT DEFAULT DEFAULT
...
iQAX = +3; %% quantile                 quants = [0.5 0.8 0.9 0.95 0.97 1.00];   %%% TRENDS PAPER DEFAULT DEFAULT DEFAULT DEFAULT
