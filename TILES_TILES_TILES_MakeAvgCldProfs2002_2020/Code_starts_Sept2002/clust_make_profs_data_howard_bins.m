...
JOB = notdone(JOB)
%JOB = 16  %% this is early Sept 2002
JOB0 = JOB;
...
fout = ['DATA/OMIGOSHTEST/pall_16daytimestep_' num2str(JOB,'%03i') '_' num2str(yy0,'%04i') '_' num2str(mm0,'%02i') '_' num2str(dd0,'%02i') '_to_' num2str(yy1,'%04i') '_' num2str(mm1,'%02i') '_' num2str(dd1,'%02i') '_' num2str(JOB,'%2i') '.mat'];
...
elseif iTempDir < 0
  junkip = ['/asl/s1/sergio/JUNK/MakeAvgProfs2002_2020/junk.ip.rtp_' num2str(JOB0)];
  junkop = ['/asl/s1/sergio/JUNK/MakeAvgProfs2002_2020/junk.op.rtp_' num2str(JOB0)];
  junkrp = ['/asl/s1/sergio/JUNK/MakeAvgProfs2002_2020/junk.rp.rtp_' num2str(JOB0)];
  junkyp = ['/asl/s1/sergio/JUNK/MakeAvgProfs2002_2020/junk.yp.txt_' num2str(JOB0)];
end
...
Npts = 46; %% I think I was crashing into memory limits
