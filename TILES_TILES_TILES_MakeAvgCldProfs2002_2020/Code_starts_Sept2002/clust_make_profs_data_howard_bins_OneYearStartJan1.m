...
iReadFileList = +1;
if iReadFileList == 1
  notdone = load('../Code_starts_Sept2002/not_finshed23_for_clust_make_profs_data_howard_bins_OneYearStartJan1.txt');
  JOB = notdone(JOB);
end

%JOB = 254     %% 2013/01/01 in clust_make_profs_data_howard_bins.m, but here GRIDBOX, A.Antaric, around -180 W, -82 S
%JOB = 2219    %% TWP over Indonesia
...
for iCnt = 1 : 23
  ...
  fout = ['../DATA_OneYear/' gridstr '/pall_gridbox_' gridstr '_16daytimestep_' num2str(iCnt,'%03i') '_' num2str(yy0,'%04i') '_' num2str(mm0,'%02i') '_' num2str(dd0,'%02i') '_to_' num2str(yy1,'%04i') '_' num2str(mm1,'%02i') '_' num2str(dd1,'%02i') '.mat'];
