...
yy0 = 2005;
JOB0 = 1;
fHoward = ['/home/motteler/shome/obs_stats/map_16day_airs_all/airs_map_all_y' num2str(yy0,'%04i') 's' num2str(JOB0,'%02i') '.mat'];
howard = load(fHoward);
...
for JOB = 1 : 400
  ...
  if thedir.bytes > 0
    ...
    if exist(fout) & ~exist(favgRP) 
      fprintf(1,'lokis like we still need to make rtp for %3i \n',JOB);
