...
figure(33); clf
plot(yymm,smooth(avg_anom_cldfrac*50,smN),'k',yymm,smooth(avg_anom_cldfracLo*50,smN),'g',yymm,smooth(avg_anom_cldfracMid*50,smN),'r',yymm,smooth(avg_anom_cldfracHi*50,smN),'b','linewidth',2)
shade(33,2023,-2,1,4,'b',0.1);
plotaxis2;
legend('cldfrac*50','cldfracLo*50','cldfracMid*50','cldfracHi*50','location','best','fontsize',10); 
ylabel('Anomaly')
title('MODIS L3 72x64 \newline cloudfrac x 50 nomalies')

figure(32); clf
plot(yymm,smooth(avg_anom_cldtop,smN),'k')
shade(32,2023,-10,1,20,'b',0.1)
plotaxis2;
legend('cldtop','location','best','fontsize',10); 
ylabel('Anomaly')
title('MODIS L3 72x64 \newline cloudtop anomalies')

figure(31); clf
plot(yymm,smooth(xavg_anom_cldfrac*50,smN),'k',yymm,smooth(xavg_anom_cldfracLo*50,smN),'g',yymm,smooth(xavg_anom_cldfracMid*50,smN),'r',yymm,smooth(xavg_anom_cldfracHi*50,smN),'b','linewidth',2); plotaxis2;
...
figure(30); clf
plot(yymm,smooth(xavg_anom_cldtop,smN),'k','linewidth',2); plotaxis2;
